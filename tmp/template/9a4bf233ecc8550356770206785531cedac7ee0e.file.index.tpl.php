<?php /* Smarty version Smarty-3.1.8, created on 2018-08-07 02:58:46
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '1613532825b44e05831deb5-05801843',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_5b44e0583393c9_98841152',
  'variables' => 
  array (
    '_layoutParams' => 0,
  ),
...
public/img/autoridades/rector.gif" width="150" class="rounded-circle z-depth-1 img-circle-d" alt="Sample avatar">
      </div>
    ...
    <div class="col-lg-3 col-md-6 mb-lg-0 mb-5">
      <div class="avatar mx-auto">
        <img src="<?php echo $_smarty_tpl->tpl_vars['_layoutParams']->value['root'];?>
public/img/autoridades/vicerrector.gif"  class="rounded-circle z-depth-1 img-circle-d" alt="Sample avatar">
      </div>
    ...
    <div class="col-lg-3 col-md-6 mb-md-0 mb-5">
      <div class="avatar mx-auto">
        <img src="<?php echo $_smarty_tpl->tpl_vars['_layoutParams']->value['root'];?>
public/img/autoridades/jefe-administrativo.gif" width="150" class="rounded-circle z-depth-1" alt="Sample avatar">
      </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4 offset-md-1 mx-3 my-3">
                ...
                <div class="view overlay">
                    <img src="<?php echo $_smarty_tpl->tpl_vars['_layoutParams']->value['root'];?>
public/img/diseño/fondo.gif" class="img-fluid" alt="Sample image for first version of blog listing">
                    <a>
...
public/img/inicio/foto2.gif" alt="Sample image">
        <a>
          <div class="mask rgba-white-slight"></div>
        </a>
      </div>
    ...
    <div class="col-lg-4 col-md-12 mb-lg-0 mb-4">
      ...
      <div class="view overlay rounded z-depth-2 mb-4">
        <img class="img-fluid img-noticias-t" src="<?php echo $_smarty_tpl->tpl_vars['_layoutParams']->value['root'];?>
public/img/inicio/foto1.gif" alt="Sample image">
        <a>
          <div class="mask rgba-white-slight"></div>
        </a>
      </div>
    ...
    <div class="col-lg-4 col-md-6 mb-md-0 mb-4">
      ...
      <div class="view overlay rounded z-depth-2 mb-4">
        <img class="img-fluid img-noticias-t" src="<?php echo $_smarty_tpl->tpl_vars['_layoutParams']->value['root'];?>
public/img/diseño/presidenteconsej.gif" alt="Sample image">
        <a>
          <div class="mask rgba-white-slight"></div>
        </a>
      </div>
